...
//                System.err.println("re-rendering with alpha = "+alpha);
    ...
    private void setupRendering(Graphics2D g2, boolean quality, Stroke stroke, Color color){        
        ...
        if (quality) {
           ...
           // g2.setColor(color);
            //MODIFY ALPHA
        //    float ov=(float)comp.getDisplayUI().getMaxOverplotting(comp)/comp.getNumRecords();
           // int alpha= (int) Math.pow(255.0, 1/2);
