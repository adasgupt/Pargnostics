...
import org.mediavirus.parvis.gui.MatrixFrame;
import org.mediavirus.parvis.gui.MatrixMetaView;
import org.mediavirus.parvis.gui.ParameterizedDisplay;
...
public class ParvisMain{
    ...
    */
    public static void main (String args[]) {
        ...
        ParameterizedDisplay paramDisplay = new ParameterizedDisplay();
        MatrixMetaView matrixView = new MatrixMetaView();
        MatrixFrame matrixFrame = new MatrixFrame(matrixView);
       
        
        metaFrame.setSize(800, 800);
        metaFrame.add(paramDisplay);
        metaFrame.setVisible(true);
        
        
       MainFrame mainFrame = new MainFrame(paramDisplay, matrixView);
